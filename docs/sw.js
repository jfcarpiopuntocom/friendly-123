...
const CACHE = "f123-shell-v138"; // bumped 2026-08-28: nav reordenado (Labels tras Expenses, antes de Advanced) + iconos: Commissions=balanza de la justicia, Sold=$ correcto, Advanced=herramienta
const SHELL = [
  "./",
  "./index.html",
  "./aislamiento.js",
