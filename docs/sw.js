...
const CACHE = "f123-shell-v47"; // bumped 2026-08-04: Fase 4 blindaje de datos - respaldo se autoverifica (relee+descifra+checksum) antes de ofrecerse para descarga
const SHELL = [
  "./",
  "./index.html",
  "./404.html",
