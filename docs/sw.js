...
const CACHE = "f123-shell-v55"; // bumped 2026-08-04: Fase 5 nueva - catch-up peer-to-peer en sync-realtime.js (relay sigue sin guardar nada, los dispositivos se pasan lo que se perdieron)
const SHELL = [
  "./",
  "./index.html",
  "./aislamiento.js",
