...
const CACHE = "f123-shell-v70"  /* bumped 2026-08-19: caza — clave de auditoria, zona horaria del panel antifraude, sync en ingles */  /* bumped 2026-08-19: rescate de licencias — la licencia por fin se guarda y se registra */  /* bumped 2026-08-19: la app reportaba al Worker de amigable, no al suyo */  /* bumped 2026-08-19: un admin cuenta contra el tope del plan gratis, y panel de Equipo en ingles */  /* bumped 2026-08-19: nav de Avanzado, QR de sync, FAB solo en PC, menu sin colores de Simon, tratos mixtos */  /* bumped 2026-08-18: tablero de control */  /* bumped 2026-08-18: estado-idb.js */; // bumped 2026-08-06: calificador de clientes portado 1-1 de amigable-123 (1-5 estrellas/corazones), fuera el tri-estado -1/0/1
const SHELL = [
  "./",
  "./index.html",
  "./aislamiento.js",
