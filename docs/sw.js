...
const CACHE = "f123-shell-v13"; // bumped 2026-07-17: fix critico localStorage compartido con AMIGABLE + bilinguismo perchas/ayuda + panel // subir el numero purga la cache vieja en todos los dispositivos
const SHELL = [
  "./",
  "./index.html",
  "./404.html",
