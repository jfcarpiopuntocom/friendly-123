...
const CACHE = "f123-shell-v43"; // bumped 2026-08-04: Fase 2 blindaje de datos - idb-archivo.js (log de actividad viejo se archiva, ya no se borra al llenarse el storage)
const SHELL = [
  "./",
  "./index.html",
  "./404.html",
