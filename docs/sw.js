...
const CACHE = "f123-shell-v15"; // bumped 2026-07-17: 5 fixes (help-tutorial, kill-switch logging, wa.me guard, instanceId validation, version check in sibling HTMLs)
const SHELL = [
  "./",
  "./index.html",
  "./404.html",
