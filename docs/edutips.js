...
(function (global) {
  ...
  var TIPS = {
    ...
    en: [
      ...
      { t: "A rack is the unit, not the store",
        c: "If you have a shop and a fair stand, they're not one pile. Split them into racks and each one tells you its own truth — which one carries the other shows up in an afternoon." },
      { t: "Restock, per rack",
        c: "Under Racks, restocking builds the shopping list on its own — what to order and in what order. That's the difference between walking into your supplier with a list versus winging it." },
      ...
      { t: "Transfers between racks leave a trail",
