...
(function () {
  const DICT = {
    en: {
      ...
      "how.lab.2html": "2. <strong>Print full label</strong> prints ONLY the label — nothing else on the page.",
      "how.lab.3": "3. Tap the barcode itself to print or save just the barcode, for smaller labels.",
      "how.lab.4": "4. The QR code links straight to the product's full record for anyone who scans it.",
    ...
    es: {
      ...
      "how.lab.2html": "2. <strong>Imprimir etiqueta completa</strong> imprime SOLO la etiqueta — nada más en la hoja.",
      "how.lab.3": "3. Toca el código de barras para imprimirlo o guardarlo solo, para etiquetas más chicas.",
      "how.lab.4": "4. El código QR lleva directo a la ficha completa del producto para quien lo escanee.",
