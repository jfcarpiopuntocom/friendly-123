...
(function () {
  ...
  // ==========================================================================
  const clientes = [
    {"id":"c01","codigo":"C-1001","nombre":"Rosa Quinde","telefono":"0991111001"},
    {"id":"c02","codigo":"C-1002","nombre":"Marco Sarmiento","telefono":"0991111002"},
    {"id":"c03","codigo":"C-1003","nombre":"Lucia Chuqui","telefono":"0991111003"},
    {"id":"c04","codigo":"C-1004","nombre":"Ivan Coronel","telefono":"0991111004"},
    {"id":"c05","codigo":"C-1005","nombre":"Maria Belen Torres","telefono":"0991111005"},
    {"id":"c06","codigo":"C-1006","nombre":"Pedro Guaman","telefono":"0991111006"},
    {"id":"c07","codigo":"C-1007","nombre":"Carmen Ulloa","telefono":"0991111007"},
    {"id":"c08","codigo":"C-1008","nombre":"Andres Vintimilla","telefono":"0991111008"}
  ];
  ...
  const OC_STATE_KEY = "amigable_demo_state_v3"; // v3 (2026-07-07): + clientes y ventas semilla
  ...
  function aplicarRespaldo(body) {
    ...
    if (Array.isArray(body.clientes)) { clientes.length = 0; clientes.push(...body.clientes); }
  ...
  function fichaCliente(c, mediana) {
    ...
    return { id: c.id, codigo: c.codigo, nombre: c.nombre, telefono: c.telefono || "", ...rfm, estacion: estacionDe(rfm, mediana == null ? medianaMontos() : mediana) };
  }
  ...
  function mov(tipo, detalle) { movimientos.push({ id: uuid("m"), tipo, detalle, fecha: new Date().toISOString() }); }
  ...
  window.fetch = async function (url, opts) {
    ...
    try {
      ...
      if (path === "/api/clientes" && (!opts || opts.method !== "POST")) {
        ...
        return J(clientes.map((c) => fichaCliente(c, med)));
      }
      if (path === "/api/clientes" && opts && opts.method === "POST") {
      ...
      if (path === "/api/clientes/matriz") {
        ...
        clientes.forEach((c) => { const f = fichaCliente(c, med); grupos[f.estacion].push(f); });
