...
(function () {
  ...
  function init() {
    ...
    syncPanel.innerHTML = `
      ...
      <p style="font-size:14px;color:var(--ink-soft);margin-top:0;">
        Por diseño este negocio corre 100% local, sin depender de internet.
  ...
  function tAccount(c) {
    ...
    return `<div class="tag-card" style="padding:12px;border-left:3px solid var(--sim-azul);">
      <div style="font-family:var(--font-display);font-weight:700;font-size:14px;text-align:center;color:var(--sim-azul-dk);border-bottom:2px solid var(--sim-azul);padding-bottom:6px;margin-bottom:4px;">${c.nombre}</div>
